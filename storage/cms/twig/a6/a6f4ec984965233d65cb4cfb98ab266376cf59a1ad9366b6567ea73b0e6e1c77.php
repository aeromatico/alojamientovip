...
class __TwigTemplate_44f151caeb7261ce0b22fac2bd452dcce8430ed626f193144c6ba1ea79d3fd71 extends Twig_Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, ($context["e"] ?? null), "landing_promos", []));
        foreach ($context['_seq'] as $context["_key"] => $context["c"]) {
                                ...
                                <div class=\"row\">
                                    <div class=\"col-md-6\">
                                        ...
                                        <div class=\"banner--content\">
                                            <h3>";
            // line 19
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "epigraph", []), "html", null, true);
            echo "</h3>
                                            <h2>";
            // line 20
            ...
            echo "</h2>
                                            ...
                                            <p>
                                                ";
            // line 23
            echo twig_get_attribute($this->env, $this->source, $context["c"], "content", []);
            echo "
                                            </p>
            
                                            <a href=\"";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "button_link", []), "html", null, true);
            echo "\" class=\"btn--primary btn--ripple\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "button_text", []), "html", null, true);
            echo "</a>
                                        </div>
                                        <!-- Promo Content End -->
                                    </div>
    ...
    public function getSourceContext()
    {
        ...
        {% partial 'widgets/warranty' %}", "/home/ubuntu/workspace/themes/master/pages/portada.htm", "");
    }
}
